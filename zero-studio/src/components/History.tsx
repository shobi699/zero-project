...
import { History as HistoryIcon, Clipboard, Check, Trash2, Search, Calendar, Clock } from 'lucide-react';
...
export default function History() {
  ...
  const [items, setItems] = useState<HistoryItem[]>([
    {
      id: '1',
      datetime: '۱۴۰۵/۰۴/۲۴ ۰۹:۱۵',
      duration: 3.5,
      text: 'لطفاً فایل‌های طراحی جدید را برای من ارسال کنید',
      strategy: 'UI Automation',
      engine: 'cloud',
    },
    {
      id: '2',
      datetime: '۱۴۰۵/۰۴/۲۴ ۰۹:۱۲',
      duration: 5.2,
      text: 'پروژه صفر به خوبی تست شده و آماده انتشار است',
      strategy: 'SendInput',
      engine: 'local',
    },
    {
      id: '3',
      datetime: '۱۴۰۵/۰۴/۲۳ ۱۸:۴۰',
      duration: 2.1,
      text: 'سلام خسته نباشید فردا جلسه ساعت ده برقرار است',
      strategy: 'Clipboard Paste',
      engine: 'cloud',
    },
    {
      id: '4',
      datetime: '۱۴۰۵/۰۴/۲۳ ۱۱:۲۰',
      duration: 4.8,
      text: 'گزارش نهایی کارکرد فازهای پروژه در قالب مارک‌داون آماده گردید',
      strategy: 'UI Automation',
      engine: 'deferred',
    },
  ]);
            ...
            >
              ...
              <div className="space-y-2 flex-1">
                <div className="flex flex-wrap items-center gap-2.5">
                  ...
                  <span className="text-[10px] text-slate-400 flex items-center gap-1">
                    <Clock className="w-3 h-3" /> {item.duration} ثانیه
                  </span>
